...
#define CONFIG_TPD_AUTO_UPDATE_FIRMWARE
#define GTP_ESD_PROTECT
#define GESTURE_DETECT_DELAY_MS  20 //ZHANGZHAO FOR GESTURE
...
struct synaptics_rmi4_data {
	...
	bool	charger_check;//zhangzhao add for charge or usb insert check
    struct workqueue_struct *gesture_workqueue;//zhangzhao add for gesture
    struct delayed_work gesture_work;   //zhangzhao add for gesture
};
